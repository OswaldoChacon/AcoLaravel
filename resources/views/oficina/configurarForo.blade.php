...
<div class="panel-body">
  <ul class="pager nav navbar-nav navbar-right" style="position: absolute; top:-11px; left: 611px;">
  ...
  $(document).ready(function() {
    ...
    var fieldHTML =
      ...
      '<div><input type="date" name="fecha[]" class="form-control" min="<?php $hoy = date("Y-m-d");
                                                                        echo $hoy; ?>" /><a href="javascript:void(0);" class="remove_button"><img src="remove-icon.png"/></a></div>' +
