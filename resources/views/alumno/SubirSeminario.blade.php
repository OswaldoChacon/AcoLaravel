    ...
    <div class="panel panel-default">
      <div class="panel-heading"style="text-align: center;background-color: #227991; ">{{$proyectoForo->titulo}}</div>
        <div class="panel-body">
          <form method="POST" action='/Guardar/{{Crypt::encrypt($proyectoForo->id)}}' enctype="multipart/form-data">
            {{csrf_field()}}
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                {!! $errors->first("'Subir Seminario'",'<span class="help-block">:message</span>')!!}
              </div>
            </div>
              <br><br>
            <div class="form-group">
